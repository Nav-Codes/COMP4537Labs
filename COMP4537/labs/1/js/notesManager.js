...
class NotesManager {
    ...
    deleteNote(noteObj) {
        ...
        //gets the index of the element so localStorageManager class knows which note to delete
    ...
    /** updates the reader page whenever there is a change made in writer.html */
    updateReader() {
